...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Privacy Policy - Door Renew</title>
        <meta 
          name="description" 
          content="Door Renew privacy policy - How we collect, use, and protect your information" 
        />
      </Head>
      ...
      <main className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-lg max-w-none">
            <h1>Door Renew Privacy Policy</h1>
            <p className="text-gray-600">Last Updated on 8/31/22. This privacy policy is effective immediately.</p>

            <h3>Introduction</h3>
<p>At Door Renew (the &ldquo;Company&rdquo; or &ldquo;We&rdquo;), we respect your privacy and are committed to protecting it through our compliance with this policy.</p>
...
<p>California Civil Code Section &sect; 1798.83 permits users of our Website that are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. To make such a request, please contact us via the Contact Us link.</p>
<h3>Data Security</h3>
...
<p>To ask questions or comment about this privacy policy and our privacy practices, contact via email at CLIENTSERVICES@DOORRENEW.COM.</p>
<p>Thank You for Visiting the Website.</p>


            <p className="text-gray-600 mt-8">Thank You for Visiting the Website.</p>
          </article>
        </div>
      </main>
    </div>
